...
SOURCES: tuple[SourceDefinition, ...] = (
    ...
    SourceDefinition("company_ir", "Company Investor Relations", "company_filing", "official", "public-web", "planned", "company-specific", ("annual_reports", "quarterly_results", "presentations", "earnings_releases", "guidance", "transcripts"), priority=98, notes="Company-specific adapter/discovery required; prefer issuer-hosted documents."),
    SourceDefinition("bse_public", "BSE Public Corporate Filings", "exchange", "official", "public-web", "planned", "https://www.bseindia.com/", ("financial_results", "announcements", "shareholding", "corporate_actions", "governance"), priority=96, notes="Use public filing documents/pages only; do not depend on undocumented paid-feed APIs."),
    SourceDefinition("sebi_filings", "SEBI Filings and Orders", "regulator", "official", "public-web", "planned", "https://www.sebi.gov.in/sebiweb/home/HomeAction.do?doListing=yes&sid=3", ("offer_documents", "takeovers", "regulatory_filings", "orders", "enforcement"), priority=95, notes="Useful for governance, capital raises, acquisitions and regulatory risk."),
